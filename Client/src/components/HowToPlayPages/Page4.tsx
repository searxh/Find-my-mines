...
export const Page4 = () => {
  return (
    <div className="m-auto text-white">
      ...
      <div className="text-left mx-auto w-[90%] text-lg">
        ● Pressing the match button will randomly match you with another user
        who also pressed the match button to a classic 6x6 game mode
      </div>
      <div className="flex text-lg mx-auto w-[90%] mx">
        <div className="">
          ...
          <div className="text-left">
            ● Pressing invite challenges a specific user to a match and allow
            you to set a custom grid and the amount of mines for your match
          </div>
          <div
